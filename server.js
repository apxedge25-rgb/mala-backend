...
// ---------------- OPENAI CALL ----------------
async function callChatGPT(systemPrompt, userPrompt, maxTokens = 800) {
...
app.post("/api/v1/talk", async (req, res) => {
  try {
    ...
    const systemPrompt = `You are Mala.ai. Speak simply in ${langLabel}. Explain like teaching a beginner.`;
